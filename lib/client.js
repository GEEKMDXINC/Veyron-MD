...
try {
    ...
    console.log("🌍 Connected to the BUGATTI MOTORS DB")
} catch {
...
let cc = Config.sessionName.replace(/VEYRON-MD;;;/gi, ""); // Dont Remove "Secktor;;;" So that You Can Use Secktor Qr too in your bot
 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    let integrate  = "_𝐁𝐔𝐆𝐀𝐓𝐓𝐈 𝐕𝐄𝐘𝐑𝐎𝐍-𝐌𝐃 has been integrated._\n_Total Plugins :"
